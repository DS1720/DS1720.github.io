...
export class FeedbackComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    annotations.forEach(annotation => {
      annotationArray.push({
        ...
        comment: counter % 2 !== 0 ? 'This is usually pronunced abcdefghias asfdlkjpo asödfoci' : '',
        links: counter % 3 !== 1 ? ['a vs. an', 'b vs. bn'] : []
      });
      counter++;
    });
  ...
  /**
   * returns 3 words before and 3 words after error, without any other errorTags inside
   */
